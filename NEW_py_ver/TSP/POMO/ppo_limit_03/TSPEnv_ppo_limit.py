...
from TSProblemDef import get_random_problems, get_local_dataset_problems, augment_xy_data_by_8_fold
...
class TSPEnv_ppo_limit:
    ...
    def load_problems(self, batch_size, episode=0, use_local_dataset=False, aug_factor=1):
        self.batch_size = batch_size

        if use_local_dataset:
            self.problems = get_local_dataset_problems(batch_size, self.problem_size, episode)
        else:
